...
var __quasar_inject_dirname__ = "/Users/sasha/Work/field-ops/frontend";
var __quasar_inject_import_meta_url__ = "file:///Users/sasha/Work/field-ops/frontend/quasar.config.js";
dotenv({ path: new URL("../env/.env.local", __quasar_inject_import_meta_url__) });
var buildTarget = process.env.BUILD_TARGET || "pwa";
...
var quasar_config_default = defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      distDir: buildTarget === "admin" ? "dist/admin" : "dist/pwa",
      env: {
        VITE_BUILD_TARGET: process.env.BUILD_TARGET,
    ...
    devServer: {
      https: true,
      port: buildTarget === "admin" ? 9100 : 9e3,
      proxy: {
        "/api": {
          target: `${API_PROTOCOL}://${API_HOST}:${API_PORT}`,
          changeOrigin: true,
